# pcp.io 翻訳プロジェクト レビューガイド

pcp.io 翻訳プロジェクトでは、翻訳対象ドキュメントからテキストを抽出し、翻訳ファイル（.poファイル）の形式にしたものを
...
Pull Requestの一覧は、 [プロジェクトページ](https://github.com/doc-l10n-kit/ja-pcp-website) の"Pull Requests"タブから
